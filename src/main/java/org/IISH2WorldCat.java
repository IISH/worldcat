...
public class IISH2WorldCat {
    ...
    public IISH2WorldCat() {
        ...
        String[] _transformers = {"/1.normalize.xsl", "/2.sortsubfield.xsl", "/3.removesinglechars.xsl", "/4.removeduplicates.xsl", "/5.fixinvalidindicator.xsl", "/6.replacepipes.xsl", "/7.rules.xsl"};
